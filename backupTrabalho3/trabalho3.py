...
def escolhaDeModelo():
    ...
    while True: # Repete a pergunta do item B.a se digitar uma opção diferente de: MCS/MLS/MCE/MLE;
        ...
        if modeloDeCamiseta == 'MCS':
            return 'Manga Curta Simples', 1.80 # Retorna o nome e o valor do modelo com base na escolha do usuário
...
if __name__ == '__main__': # padrão python para nomear programa principal
    modelo, valorUnidade = escolhaDeModelo() # Solicita o modelo e obtem o nome e o valor da unidade
...
# print para exibir o valor total a pagar
